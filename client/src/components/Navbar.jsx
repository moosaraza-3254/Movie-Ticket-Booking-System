...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-50 w-full flex items-center
            justify-between px-6 md:px-16 lg:px-36 py-5 bg-transparent'>
            ...
            <div className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium
                ...
                gap-8 min-md:px-8 py-3 max-md:h-screen min-md:rounded-full backdrop-blur bg-black/5
            ...
            <div className='flex items-center gap-8'>
                ...
                {!user ? (
                    <Link to="/sign-in" className='px-4 py-1 sm:px-7 sm:py-2 bg-primary hover:bg-primary-dull
                        transition rounded-full font font-medium cursor-pointer'>
                        Login
                    </Link>
                ) : (
                        <UserButton>
